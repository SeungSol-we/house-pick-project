...
export default function Sign_Up() {
  return (
    <div className="px-5 w-{100vw} h-{100vh} bg-[#FFF6FE]">
        ...
        <input className="w-full h-12 mt-2 px-4 text-xs text-red-300 bg-white rounded-full focus:outline-none " type="text" name="username" placeholder="여기에 성함을 입력해 주세요" />
